...
public class FontIndexMobileController extends BaseController {
    private static final Logger LOGGER = LoggerFactory.getLogger(FontIndexMobileController.class);
...
//        对于空格的特殊处理
        ...
        return mobileRender("page-category");
    }
    ...
    public void logout(HttpSession session, HttpServletResponse response) {
        TaleUtils.mobileLogout(session, response);
    }
    ...
    public String login(HttpServletRequest request) {
        ...
        try{
            ...
            for (int i = 0; i < cookie.length; i++) {
                ...
                if("remeberMe".equalsIgnoreCase(cook.getName())){
                    request.setAttribute("remeberMe",cook.getValue().toString());
                }
                else if("password".equalsIgnoreCase(cook.getName())){
    ...
    public String register() {
        return "mobile/default/register";
    }
    ...
    public String forget(HttpServletRequest request){
        return "mobile/default/forget_pwd";
    }
            ...
            if(stu!=null){
                ...
                if((stu.getOutDate().getTime()/1000*1000)<=System.currentTimeMillis()){
                    ...
                    if(!digitalSignature.equals(sid)){
                        ...
                        return "mobile/default/find_pwd";
                    }
                }
            }else{
    ...
    public String page(@PathVariable("pagename") String pagename, HttpServletRequest request) {
        ...
        if (contents.getAllowComment()) {
             ...
             if (StringUtils.isBlank(cp)) {
                 PageInfo<CommentBo> commentsPaginator = commentService.getComments(contents.getCid(), Integer.parseInt("1"), 6);
    ...
    public String pPostSearch(HttpServletRequest request, @PathVariable("p") int p, @RequestParam(value = "limit", defaultValue = "12") int limit,ArticleSearchForm form){
        ...
        return mobileRender("postsearch");
    }
