...
import com.pwt.service.impl.ContentServiceImpl;
...
public final class Commons {
    ...
    public static String aesEncrypt(String password){
        String encrypt = null;
        try {
            encrypt= AesUtil.aesEncrypt(password,"abcdefgabcdefg12");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return encrypt;
    ...
    public static String aesDecrypt(String password){
        String encrypt = null;
        try {
            encrypt= AesUtil.aesDecrypt(password,"abcdefgabcdefg12");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return encrypt;
